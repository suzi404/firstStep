...
angular.module('app').controller('jsObjCtrl', ['$rootScope', '$scope', '$filter', function($rootScope, $scope, $filter) {
    ...
    console.log(dataChange(data));//00000001233
    console.log(dataChange(data2));//000000000030
    console.log(dataChange('22'));//000000002200
