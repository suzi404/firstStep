...
angular.module('app').controller('jsStrCtrl', ['$rootScope', '$scope',  function($rootScope, $scope) {
     ...
     * 转换为字符串
     * 用法：arr.toString(num);
     * 说明：num为基数，可以选择转换是2--二进制，10--10进制等等，不填默认为10进制。只有数字的字符串类型会被转换，别的不变
     * 返回：字符串
